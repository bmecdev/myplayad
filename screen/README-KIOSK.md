...
## 1. Rotación Permanente de Pantalla (Hotplug-safe)
Para que la pantalla se mantenga en orientación vertical (90 grados) incluso si se desconecta y reconecta el cable HDMI, configuramos el demonio `kanshi`.
